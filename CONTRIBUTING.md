# Contributing to hellofresh/updater-go

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to `hellofresh/updater-go`, 
...
We accept contributions via Pull Requests on [Github](https://github.com/hellofresh/updater-go).

## How Can I Contribute?

### Reporting Bugs

This section guides you through submitting a bug report for `hellofresh/updater-go`. Following these guidelines helps maintainers 
...
* **Describe the exact steps which reproduce the problem** in as many details as possible. For example, start by explaining how you started `hellofresh/updater-go`, 
...
* **Which version of `hellofresh/updater-go` are you using?**
* **What's the name and version of the OS you're using**?

### Your First Code Contribution

Unsure where to begin contributing to `hellofresh/updater-go`? You can start by looking through these `beginner` and `help-wanted` issues:
